...
static const u8 sRivalAvatarGfxIds[][GENDERS_COUNT] =
{
    [PLAYER_AVATAR_STATE_NORMAL]     = {OBJ_EVENT_GFX_RIVAL_BRENDAN_NORMAL,     OBJ_EVENT_GFX_RIVAL_MAY_NORMAL,       OBJ_EVENT_GFX_RIVAL_KRIS_NORMAL},
    [PLAYER_AVATAR_STATE_MACH_BIKE]  = {OBJ_EVENT_GFX_RIVAL_BRENDAN_MACH_BIKE,  OBJ_EVENT_GFX_RIVAL_MAY_MACH_BIKE,    OBJ_EVENT_GFX_RIVAL_KRIS_MACH_BIKE},
    [PLAYER_AVATAR_STATE_ACRO_BIKE]  = {OBJ_EVENT_GFX_RIVAL_BRENDAN_ACRO_BIKE,  OBJ_EVENT_GFX_RIVAL_MAY_ACRO_BIKE,    OBJ_EVENT_GFX_RIVAL_KRIS_ACRO_BIKE},
    [PLAYER_AVATAR_STATE_SURFING]    = {OBJ_EVENT_GFX_RIVAL_BRENDAN_SURFING,    OBJ_EVENT_GFX_RIVAL_MAY_SURFING,      OBJ_EVENT_GFX_RIVAL_KRIS_SURFING},
    [PLAYER_AVATAR_STATE_UNDERWATER] = {OBJ_EVENT_GFX_BRENDAN_UNDERWATER,       OBJ_EVENT_GFX_MAY_UNDERWATER,         OBJ_EVENT_GFX_KRIS_UNDERWATER},
    [PLAYER_AVATAR_STATE_FIELD_MOVE] = {OBJ_EVENT_GFX_RIVAL_BRENDAN_FIELD_MOVE, OBJ_EVENT_GFX_RIVAL_MAY_FIELD_MOVE,   OBJ_EVENT_GFX_RIVAL_KRIS_FIELD_MOVE},
    [PLAYER_AVATAR_STATE_FISHING]    = {OBJ_EVENT_GFX_BRENDAN_FISHING,          OBJ_EVENT_GFX_MAY_FISHING,            OBJ_EVENT_GFX_KRIS_FISHING},
    [PLAYER_AVATAR_STATE_WATERING]   = {OBJ_EVENT_GFX_BRENDAN_WATERING,         OBJ_EVENT_GFX_MAY_WATERING,           OBJ_EVENT_GFX_KRIS_WATERING},
    [PLAYER_AVATAR_STATE_VSSEEKER]   = {OBJ_EVENT_GFX_RIVAL_BRENDAN_FIELD_MOVE, OBJ_EVENT_GFX_RIVAL_MAY_FIELD_MOVE,   OBJ_EVENT_GFX_RIVAL_KRIS_FIELD_MOVE},
};

static const u16 sPlayerAvatarGfxIds[][GENDERS_COUNT] =
{
    [PLAYER_AVATAR_STATE_NORMAL]     = {PLAYER_AVATAR_GFX_MALE_NORMAL,     PLAYER_AVATAR_GFX_FEMALE_NORMAL,         PLAYER_AVATAR_GFX_ANDRO_NORMAL},
    [PLAYER_AVATAR_STATE_MACH_BIKE]  = {PLAYER_AVATAR_GFX_MALE_MACH_BIKE,  PLAYER_AVATAR_GFX_FEMALE_MACH_BIKE,      PLAYER_AVATAR_GFX_ANDRO_MACH_BIKE},
    [PLAYER_AVATAR_STATE_ACRO_BIKE]  = {PLAYER_AVATAR_GFX_MALE_ACRO_BIKE,  PLAYER_AVATAR_GFX_FEMALE_ACRO_BIKE,      PLAYER_AVATAR_GFX_ANDRO_ACRO_BIKE},
    [PLAYER_AVATAR_STATE_SURFING]    = {PLAYER_AVATAR_GFX_MALE_SURFING,    PLAYER_AVATAR_GFX_FEMALE_SURFING,        PLAYER_AVATAR_GFX_ANDRO_SURFING},
    [PLAYER_AVATAR_STATE_UNDERWATER] = {PLAYER_AVATAR_GFX_MALE_UNDERWATER, PLAYER_AVATAR_GFX_FEMALE_UNDERWATER,     PLAYER_AVATAR_GFX_ANDRO_UNDERWATER},
    [PLAYER_AVATAR_STATE_FIELD_MOVE] = {PLAYER_AVATAR_GFX_MALE_FIELD_MOVE, PLAYER_AVATAR_GFX_FEMALE_FIELD_MOVE,     PLAYER_AVATAR_GFX_ANDRO_FIELD_MOVE},
    [PLAYER_AVATAR_STATE_FISHING]    = {PLAYER_AVATAR_GFX_MALE_FISHING,    PLAYER_AVATAR_GFX_FEMALE_FISHING,        PLAYER_AVATAR_GFX_ANDRO_FISHING},
    [PLAYER_AVATAR_STATE_WATERING]   = {PLAYER_AVATAR_GFX_MALE_WATERING,   PLAYER_AVATAR_GFX_FEMALE_WATERING,       PLAYER_AVATAR_GFX_ANDRO_WATERING},
    [PLAYER_AVATAR_STATE_VSSEEKER]   = {PLAYER_AVATAR_GFX_MALE_VSSEEKER,   PLAYER_AVATAR_GFX_FEMALE_VSSEEKER,       PLAYER_AVATAR_GFX_ANDRO_VSSEEKER},
};

static const u8 sFRLGAvatarGfxIds[GENDERS_COUNT] =
{
    [GENDER_MASCULINE]   = OBJ_EVENT_GFX_RED,
    [GENDER_FEMININE]    = OBJ_EVENT_GFX_LEAF,
    [GENDER_ANDROGYNOUS] = OBJ_EVENT_GFX_LEAF,
};
...
static const struct PACKED
{
    u16 graphicsId;
    u8 playerFlag;
} sPlayerAvatarGfxToStateFlag[GENDERS_COUNT][5] =
{
    [GENDER_MASCULINE] =
    {
    ...
    [GENDER_ANDROGYNOUS] =
    {
        {PLAYER_AVATAR_GFX_ANDRO_NORMAL,         PLAYER_AVATAR_FLAG_ON_FOOT},
        {PLAYER_AVATAR_GFX_ANDRO_MACH_BIKE,      PLAYER_AVATAR_FLAG_MACH_BIKE},
        {PLAYER_AVATAR_GFX_ANDRO_ACRO_BIKE,      PLAYER_AVATAR_FLAG_ACRO_BIKE},
        {PLAYER_AVATAR_GFX_ANDRO_SURFING,        PLAYER_AVATAR_FLAG_SURFING},
        {PLAYER_AVATAR_GFX_ANDRO_UNDERWATER,     PLAYER_AVATAR_FLAG_UNDERWATER},
    }
};
