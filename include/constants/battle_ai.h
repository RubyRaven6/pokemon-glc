...
#define AI_FLAG_GOOD_TRAINER          (AI_FLAG_BASIC_TRAINER | AI_FLAG_ASSUME_STAB | AI_FLAG_SMART_SWITCHING | AI_FLAG_SMART_MON_CHOICES | AI_FLAG_PP_STALL_PREVENTION | AI_FLAG_SMART_TERA | AI_FLAG_RANDOMIZE_SWITCHIN)
